    ...
    public static void main(String[] args) throws IOException{
        ...
        System.out.println("\nEstos son los pokemones que puden estar en batalla");
            ...
            for(int i = 0; i< listapokemones.size(); i++){
                System.out.println((i+1)+"....."+listapokemones.get(i).getApodo()+"     tipo: "+listapokemones.get(i).tipo);  //se invoca el método toString de la clase Coche 
            }
        ...
        while(partida<7){
            ...
            if(auxj1.getVida()<auxj2.getVida()){
                ...
                System.out.println(jugador2.getNombre() + ( puntajej2 + 1) + " - " + (puntajej1 + 1 ) + jugador1.getNombre());
                puntajej2=1;
            }else{
                System.out.println("Esta batalla la gana" + jugador1.getNombre());
                System.out.println(jugador1.getNombre() + ( puntajej1 + 1) + " - " + (puntajej2 + 1 ) + jugador2.getNombre());
                puntajej1=1;
            }
            partida++;
